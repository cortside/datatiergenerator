		...
		public void GenerateSource() {
			...
			foreach (Entity entity in entities) {
				if (!entity.HasUpdatableFields()) {
					Console.Out.WriteLine("entity " + entity.Name + " does not have any editable fields and does not have x specified.  No update stored procedures or update DAO methods will be generated.");
				}
