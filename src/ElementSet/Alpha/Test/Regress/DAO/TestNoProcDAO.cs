...
{
    public class TestNoProcDAO : Spring2.Core.DAO.EntityDAO
    {

	private static readonly String VIEW = "vwTestNoProc";
	...
	/// <summary>
	/// Returns a list of all TestNoProc rows.
	/// </summary>
	/// <returns>List of TestNoProcData objects.</returns>
	...
	/// <summary>
	/// Returns a filtered list of TestNoProc rows.
	/// </summary>
	...
	/// <summary>
	/// Returns an ordered list of TestNoProc rows.  All rows in the database are returned
	/// </summary>
	...
	/// <summary>
	/// Returns an ordered and filtered list of TestNoProc rows.
	/// </summary>
	/// <param name="whereClause">Filtering criteria.</param>
	/// <param name="orderByClause">Ordering criteria.</param>
	/// <returns>List of TestNoProcData objects.</returns>
	...
	/// <summary>
	/// Finds a TestNoProc entity using it's primary key.
	/// </summary>
	/// <returns>A TestNoProcData object.</returns>
	/// <exception cref="Spring2.Core.DAO.FinderException">Thrown when no entity exists witht he specified primary key..</exception>
	public static TestNoProcData Load()
	{
	    ...
	    {
		dataReader.Close();
		throw new FinderException("Load found no rows for TestNoProc.");
	    }
	    TestNoProcData data = GetDataObjectFromReader(dataReader);
	    dataReader.Close();
	    return data;
	}
	...
	private static TestNoProcData GetDataObjectFromReader(SqlDataReader dataReader)
	{
	    TestNoProcData data = new TestNoProcData();
	...
	/// <returns>The list of TestNoProcDAO objects found.</returns>
	...
	/// <exception cref="Spring2.Core.DAO.FinderException">Thrown when no rows are found.</exception>
	public static TestNoProcData FindByPK(StringType stringColumn, IdType int32Column)
	{
	    ...
	    {
		dataReader.Close();
		throw new FinderException("TestNoProcData.FindByPK found no rows.");
	    }
	    TestNoProcData data = GetDataObjectFromReader(dataReader);
	    dataReader.Close();
	    return data;
