...
{
    public class TestUpdateChangedOnlyDAO : Spring2.Core.DAO.EntityDAO
    {

	private static readonly String VIEW = "vwTestUpdateChangedOnly";
	...
	/// </summary>
	static TestUpdateChangedOnlyDAO()
	{
	...
	/// <summary>
	/// Returns a list of all TestUpdateChangedOnly rows.
	/// </summary>
	/// <returns>List of TestUpdateChangedOnlyData objects.</returns>
	...
	/// <summary>
	/// Returns a filtered list of TestUpdateChangedOnly rows.
	/// </summary>
	...
	/// <summary>
	/// Returns an ordered list of TestUpdateChangedOnly rows.  All rows in the database are returned
	/// </summary>
	...
	/// <summary>
	/// Returns an ordered and filtered list of TestUpdateChangedOnly rows.
	/// </summary>
	/// <param name="whereClause">Filtering criteria.</param>
	/// <param name="orderByClause">Ordering criteria.</param>
	/// <returns>List of TestUpdateChangedOnlyData objects.</returns>
	...
	/// <summary>
	/// Finds a TestUpdateChangedOnly entity using it's primary key.
	/// </summary>
	/// <returns>A TestUpdateChangedOnlyData object.</returns>
	/// <exception cref="Spring2.Core.DAO.FinderException">Thrown when no entity exists witht he specified primary key..</exception>
	public static TestUpdateChangedOnlyData Load()
	{
	    ...
	    {
		dataReader.Close();
		throw new FinderException("Load found no rows for TestUpdateChangedOnly.");
	    }
