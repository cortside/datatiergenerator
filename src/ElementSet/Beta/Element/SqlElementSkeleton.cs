...
namespace Spring2.DataTierGenerator.Element {
    ...
    /// </summary>
    public abstract class SqlElementSkeleton : ElementSkeleton {

	public SqlElementSkeleton() {}

	public SqlElementSkeleton(XmlNode node) : base(node) {}

	public String EscapedName {
	    get { return EscapeSqlName(Name); }
	}
